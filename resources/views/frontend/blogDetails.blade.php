                                      ...
                                      <div class="media">
                                        <div class="media-left">
                                          <a class="news-img" href="#">
                                            <img class="media-object" src="{{ asset('assets/frontend/images/doctor-2.jpg') }}" alt="img">
                                          </a>
                                        </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6 col-sm-6">
                                            <div class="media">
                                                <div class="media-left">
                                                  <a class="news-img" href="#">
                                                    <img class="media-object" src="{{ asset('assets/frontend/images/small-blog-img1.jpg') }}" alt="img">
                                                  </a>
                                                </div>
                                                <div class="media-body">
                                      ...
                                      <div class="comments">
                                        <ul class="commentlist">
                                          <li>
                                            <div class="media">
                                              <div class="media-left">
                                                  <img alt="img" src="{{ asset('assets/frontend/images/doctor-2.jpg') }}" class="media-object news-img">
                                              </div>
                                              <div class="media-body">
