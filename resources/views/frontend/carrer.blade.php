            ...
            <div class="col-lg-7 col-md-7 col-sm-6">
              <div class="contact-form">
                <div class="section-heading">
                  ...
                  <p>Post For Senir Staf Nurse</p>
                  <div class="line"></div>
                </div>
                <p>Fill out all required Field to send a Message. Please don't spam,Thank you!</p>
                <form class="submitphoto_form">
                  <input type="text" class="wp-form-control wpcf7-text" placeholder="Name of applicant">
                  ...
                  <span style="font-weight: bold">Sex: </span> <label class="radio-inline">
                  ...
                  <textarea class="wp-form-control wpcf7-textarea" cols="30" rows="2" placeholder="Experinces"></textarea>
                  {{-- <div class="row">
                  ...
                  <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                                <input id="f02" type="file"/>
                                <label for="f02">Attach File</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
