                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="size_type" <?php echo ($product->size_type == 1) ?  "checked" : "" ;  ?> type="radio" class="with-gap" id="radio_5" value="1">
                                    <label for="radio_5">Fixed Size</label>
                                    <input name="size_type" <?php echo ($product->size_type == 2) ?  "checked" : "" ;  ?> type="radio" class="with-gap" id="radio_6" value="2">
